...
import com.xiaojianli.wechat.login.impl.LoginPresenterImpl;
...
public class LoginActivity extends Activity implements OnClickListener,
	...
	public void LoginSuccess() {
		appLog.e("LoginSuccess");
		mHanlder.removeMessages(REMOVE_DIALOG);
		mHanlder.sendEmptyMessage(LOGIN_SUCCESS);
	}

	@Override
	public void LoginFailed() {
		mHanlder.removeMessages(REMOVE_DIALOG);
		mHanlder.sendEmptyMessage(LOGIN_FAILED);
	...
	public void LoginError() {
		mHanlder.removeMessages(REMOVE_DIALOG);
		mHanlder.sendEmptyMessage(CONNECT_ERROR);
	}
...
//			if (true) return;
			...
			mLoginPresenter.Login(LoginInfo);
			break;
